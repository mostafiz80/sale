...
@section('content')
    <div class="container-fluid">
        <div class="mb-3">
            <h1 class="h3 d-inline align-middle">Add new sale</h1>
                    ...
                    <div class="card-body">
                        <form action="" method="post" class="form-control">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="daily_sale" id="daily_sale"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="daily_parchase" id="daily_parchase"
                                    aria-describedby="helpId" placeholder="" />
                                <small id="helpId" class="form-text text-muted">Enter Amount "375000"</small>
                            </div>
                            <div class="mb-3">
                                <label for="daily_cash_profit" class="form-label">Daily Cash Profit</label>
                                <input type="number" class="form-control" name="daily_cash_profit" id="daily_cash_profit"
                                    aria-describedby="helpId" placeholder="" />
                                <small id="helpId" class="form-text text-muted">Enter Amount "375000"</small>
                            </div>
                            <div class="mb-3">
                                <label for="total_daily_profit" class="form-label">Daily Total Profit</label>
                                <input type="number" class="form-control" name="total_daily_profit" id="total_daily_profit"
                                    aria-describedby="helpId" placeholder="" />
                                <small id="helpId" class="form-text text-muted">Enter Amount "375000"</small>
                            </div>
                            <div class="mb-3">
                                <label for="daily_closed_balance" class="form-label">Daily Closed Balance</label>
                                <input type="number" class="form-control" name="daily_closed_balance"
